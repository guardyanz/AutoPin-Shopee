...
const transitions: Record<JobState, readonly JobState[]> = {
  ...
  discover_products: ['select_candidate', 'awaiting_approval', 'daily_limit_reached', 'paused', 'stopped'],
  select_candidate: ['extract_product', 'awaiting_approval', 'daily_limit_reached', 'paused', 'stopped'],
  ...
  render_poster: ['select_candidate', 'paused', 'stopped'],
  await_publish_slot: ['fill_pinterest', 'paused', 'stopped'],
  fill_pinterest: ['publish_pinterest', 'daily_limit_reached', 'paused', 'stopped'],
  awaiting_approval: ['await_publish_slot', 'paused', 'stopped'],
  ...
  cleanup: ['await_publish_slot', 'daily_limit_reached', 'paused', 'stopped'],
