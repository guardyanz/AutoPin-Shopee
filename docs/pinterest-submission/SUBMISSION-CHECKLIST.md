...
- [ ] Confirm each Pin requires an explicit user approval action.
...
- [ ] Video shows OAuth, requested scopes, one reviewed Pin, one explicit approval, live API result, and disconnect.
